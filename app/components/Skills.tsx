      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {skills.map((skill, index) => (
            <motion.div
              key={skill.name}
              className={`${darkMode ? "bg-gray-700" : "bg-white"} p-4 rounded-full shadow-md flex flex-col items-center justify-center w-24 h-24`}
            ...
            >
              ...
              <span className={`text-xs text-center ${darkMode ? "text-gray-200" : "text-gray-800"}`}>
                {skill.name}
              </span>
            </motion.div>
          ))}
